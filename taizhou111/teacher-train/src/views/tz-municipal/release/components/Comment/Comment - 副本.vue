<template>
  <div class="hbl-fa">
    ...
    <div class="hbl-comm">
      <!-- 头像 -->
      <div class="comment-avatar" v-if="showAvatar"><avatar :avatar="avatar"></avatar></div>
      <div class="comment">
    ...
    <div v-for="(item, index) in commentList" class="hbl-child">
      ...
      <div class="content">
        <div class="comment-f">
          <img src="http://localhost:81/static/img/avatar.cbb8740b.jpg" style="width: 45px;height: 45px;border-radius: 50%;" />
        ...
        <div class="comment-f">
          <div>
            ...
            <div class="date author">{{ item.createDate }}</div>
        ...
        <div class="reply-content reply-fa">
          <div class="reply-font" @click="doReply(item)">
            <div>
          ...
          <div class="comment" style="width: 100%" v-if="replyMap[item.id]" :showAvatar="showAvatar">
            <el-input @focus="showButton(item.id)" type="textarea" :autosize="{ minRows: 2, maxRows: 4 }" :placeholder="placeholder" v-model="textareaMap[item.id]"></el-input>
            ...
            <div v-if="buttonMap[item.id]" class="hbl-owo">
              <div :class="pBodyMap[item.id] ? 'OwO' : 'OwO OwO-open'" class="emoj publish" :style="{ width: emojiWidth }">
                <div class="OwO-logo" @click="pBodyStatus(item.id)"><span>Emoji表情</span></div>
        ...
        <div class="content">
          ...
          <div class="comment-f">
            <div>
              ...
              <div class="unit author">(兴化市中心小学)</div>
              <div v-if="ritem.commentUser.id === authorId" class="icon author">{{ label }}</div>
              <div class="date author">{{ ritem.createDate }}</div>
            </div>
          </div>
          ...
          <div class="reply-content reply-fa">
            ...
            <div class="comment" style="width: 100%" v-if="replyMap[ritem.id]" :showAvatar="showAvatar">
              <el-input @focus="showButton(ritem.id)" type="textarea" :autosize="{ minRows: 2, maxRows: 4 }" :placeholder="placeholder" v-model="textareaMap[ritem.id]"></el-input>
              ...
              <div v-if="buttonMap[ritem.id]" class="hbl-owo">
                <div :class="pBodyMap[ritem.id] ? 'OwO' : 'OwO OwO-open'" class="emoj publish" :style="{ width: emojiWidth }">
                  <div class="OwO-logo" @click="pBodyStatus(ritem.id)"><span>Emoji表情</span></div>
                  <div class="OwO-body">
                    <ul class="OwO-items OwO-items-show">
