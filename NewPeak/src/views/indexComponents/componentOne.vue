...
export default {
  ...
  methods: {
    ...
    changePicture(action) {
      ...
      this.currentLink = this.bannerList[this.currentIndex].linkurl;
...
.pre-picture {
  background-image: url("../../assets/img/icon_left_default1.png");
  background-size: 100% 100%;
...
.next-picture {
  background-image: url("../../assets/img/icon_right_default1.png");
  background-size: 100% 100%;
  background-color: #ffffff;
  width: 24px;
  height: 24px;
