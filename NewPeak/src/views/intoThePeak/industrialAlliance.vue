...
.icon-more-document{
  width: 88px;
  height: 27px;
  background: url("../../assets/images/Group 108@3x.png");
  background-size: 100% 100%;
}
.icon-more-document:hover{
  width: 88px;
  height: 27px;
  background: url("../../assets/images/Group 107@3x.png");
  background-size: 100% 100%;
}
...
.row1-link-more{
  margin-left: 900px;
  background-image: url("../../assets/images/Group 374@2x.png");
  width: 140px;
  height: 36px;
  font-size: 24px;
...
.row1-link-more:hover{
  ...
  left: 1543px;*/
  margin-left: 900px;
  background-image: url("../../assets/images/Group 397@2x.png");
  width: 140px;
  height: 36px;
  font-size: 24px;
  font-family: Source Han Sans CN-Normal, Source Han Sans CN;
