<template>
	<div id="app">
		<div class="content"><img src="../../assets/imgs/bg1.png" alt="" /></div>
		...
		<div class="info">
			<div class="left">
				<div class="left">
					中国
					<span style="color: #C8000A;font-weight: 800;">{{ info.wenlv_head_enterprise }}</span>
				</div>
				<div class="left">
					<span style="color: #C8000A;font-weight: 800;">{{ info.wenlv_industries_num }}</span>
					美丽中国价值经典
				</div>
				<div class="left">
					<span style="color: #C8000A;font-weight: 800;">{{ info.wenlv_years_num }}</span>
					文旅行业不辍耕耘
				</div>
			</div>
			<div class="line"></div>
			<div class="right">
				<div class="right">
					<span style="color: #C8000A;font-weight: 800;">{{ info.wenlv_scenic_spot }}</span>
					专业运营旅游景区
				</div>
				<div class="right">
					文旅产业
					<span style="color: #C8000A;font-weight: 800;">{{ info.wenlv_title }}</span>
				</div>
		...
		<div class="news">
			<div class="newsTitle">
				<div class="newsBar">
					<div class="newsFirst">NEWS /</div>
					<div class="newsSecond">巅峰要闻</div>
				</div>
			...
			<div class="showImg" v-for="(item, i) in news" :key="i">
				...
				<div class="first"><img :src="getImgUrl(item.original_image)" alt="" /></div>
				<br />
				<div class="second"><img src="../../assets/imgs/detail.png" @click="newJump(item.id)" alt="" /></div>
			</div>
		</div>
		<div class="brandTitle">
			中国文旅智业
			<span style="color: #C8000A">头部品牌</span>
		</div>
		<div class="brand">
			<ul class="brandNums">
				<li class="brandNum" v-for="(item, i) in brandInfo" :key="i">
					<div class="img"><img :src="require(`../../assets/bei/${item.img}.png`)" alt="" /></div>
		...
		<div class="message">
			<div class="messageFirst">
				<div class="onlineTitle">Contact us /</div>
				<div class="onlineMes">在线留言</div>
			</div>
			<div class="messageSecond">
				<div class="company">
					<input class="posInp" v-model="company" placeholder="请输入您的企业名称" />
					<img class="inpIcon" src="../../assets/imgs/city.png" alt="" />
				</div>
				<div class="company">
					<input class="posInp" v-model="name" placeholder="请输入您的姓名" />
					<img class="inpIcon" src="../../assets/imgs/people.png" alt="" />
				</div>
				<div class="company">
					<input class="posInp" v-model="phone" placeholder="请输入您的电话号码" />
					<img class="inpIcon" src="../../assets/imgs/tel.png" alt="" />
				</div>
				<div class="btn"><button class="btnSub" @click="sendForm">确认提交</button></div>
...
.brand {
	...
	.brandFooter {
		...
		overflow-x: scroll;
		height: 3.33rem;
		background: linear-gradient(225deg, #f2f2f2 0%, rgba(240, 240, 240, 0.7) 100%);
		display: flex;
		overflow: -moz-scrollbars-none;
		overflow: -moz-scrollbars-none;
		&::-webkit-scrollbar {
