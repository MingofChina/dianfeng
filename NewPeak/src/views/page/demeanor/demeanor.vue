<template>
	<div id="app">
		<div class="showImg">
			<img src="../../../assets/imgs/fengCai.png" alt="" />
			<div>
		...
		<div class="show" v-for="(item, i) in viewArr" :key="i">
		...
		<div class="pic">
			<div class="bar">
				<div class="barNums" v-for="(item, i) in barInfo" :key="i" @click="jump(i)">
					<div class="barTitle " :class="changeColor == i ? 'active' : ''">{{ item.title }}</div>
					<div class="stick">|</div>
				</div>
			</div>
			...
			<el-carousel arrow="always" :autoplay="false" indicator-position="none">
				<el-carousel-item v-for="(it, idx) in barInfo[openTitle].original_image" :key="idx">
					<img :src="getImgUrl(it.original_image)" alt="" />
		...
		<div class="foot">
			<div class="bar">
				<div class="barNums" v-for="(item, i) in footBarInfo" :key="i" @click="jumpOne(i)">
					<div class="barTitle" :class="changeColorOne == i ? 'active' : ''">{{ item.title }}</div>
					<div class="stick">|</div>
				</div>
			</div>
			...
			<el-carousel arrow="always" :autoplay="false" indicator-position="none">
				<el-carousel-item v-for="(it, idx) in footBarInfo[openTitleOne].original_image" :key="idx">
					<img :src="getImgUrl(it.original_image)" alt="" />
					<!-- <div class="imgTitle">{{it.title}}</div> -->
				</el-carousel-item>
			</el-carousel>
