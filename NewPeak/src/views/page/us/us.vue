<template>
	<div id="app">
		<div class="showImg">
			<img src="../../../assets/imgs/us.png" alt="" />
			<div>
				<div class="cha">联系我们</div>
				<div class="eng">Contact work</div>
			</div>
		</div>
		<div class="content"><div id="container" style="width:width: 34.8rem;height: 18.42rem;"></div></div>
		<div class="mark" v-for="(item, i) in addressInfo" :key="i">
			<div class="address">
